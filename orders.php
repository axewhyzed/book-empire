...
require_once "database_functions.php";
    ...
    $result=$conn->query($sql);
        ...
        while($raw=$result->fetch_assoc() )
        {
            ...
            echo "customerid             : ".$raw["customerid"]."<br>";
            echo "amount                 : ".$raw["amount"]."<br>";
            echo "ship address           : ".$raw["ship_address"]."<br>";
            echo "ship name              : ".$raw["ship_name"]."<br>";
            echo "ship country           : ".$raw["ship_country"]."<br>";
            echo "ship zip code          : ".$raw["ship_zip_code"]."<br>";

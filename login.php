...
<body>
    ...
    <div class="form-container">
        <form action="" method="post">
            <h3>login now</h3><br>
            Email : <br>
            <input type="email" name="email" class="frm-login" placeholder="enter your email" required
                class="box"><br><br>
            Password:<br>
            <input type="password" name="password" class="frm-login" placeholder="enter your password" required
                class="box"><br>
